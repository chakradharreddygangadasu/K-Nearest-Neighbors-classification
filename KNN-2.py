...
# Creating KNN model on the training dataset
...
"""From this KNN model we got the accuracy of 93% which is quite good compared to the logistic regression model,
which gave 89% accuracy."""
